...
uint8_t PPU::readRegister(uint16_t address) {
	...
	case(0x2002):  // PPUSTATUS
		...
		returnValue = this->registers.PPUSTATUS;
		clrBit(this->registers.PPUSTATUS, 7);  // Clear the Vblank flag.
		break;
	case(0x2007):  // PPUDATA
...
bool PPU::requestingNMI() const {
	...
	bool requestNMI = (getBit(this->registers.PPUCTRL, 7)) && this->reachedVblank();
